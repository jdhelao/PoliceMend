...
use App\Http\Controllers\OrdenMantenimientoActividadController;
...
Route::get('/orden-mantenimiento/{id}/repuestos',[OrdenMantenimientoRepuestoController::class,'getSparePartsFromOrder']);
Route::patch('/orden-mantenimiento/actividades',[OrdenMantenimientoActividadController::class,'save']);
Route::patch('/orden-mantenimiento/repuestos',[OrdenMantenimientoRepuestoController::class,'save']);
Route::get('/orden-mantenimiento/reporte/{ini}/{end}/{fin}',[OrdenMantenimientoController::class,'getReport']);
...
Route::get('/orden-movilizaciones/{id}/persona/{person}',[OrdenAbastecimientoController::class,'getOrderByPerson']);
Route::get('/orden-movilizaciones/reporte/{ini}/{end}',[OrdenAbastecimientoController::class,'getReport']);
Route::put('/orden-movilizaciones',[OrdenAbastecimientoController::class,'update']);

Route::get('/repuestos',[RepuestoController::class,'index']);
Route::get('/repuestos/{all}',[RepuestoController::class,'read']);
