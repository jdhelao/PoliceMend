...
Route::get('/orden-movilizaciones/{id}/persona/{person}',[OrdenMovilizacionController::class,'getOrderByPerson']);
Route::get('/orden-movilizaciones/reporte/{ini}/{end}',[OrdenMovilizacionController::class,'getReport']);
Route::put('/orden-movilizaciones',[OrdenMovilizacionController::class,'update']);
