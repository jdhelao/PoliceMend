...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('aplicaciones')->insertOrIgnore(['ap_codigo' => 8, 'ap_nombre' => 'Repuestos' ,'ap_ruta' => '/admin/repuesto', 'ap_imagen' => null]);
        ...
        DB::table('aplicaciones')->insertOrIgnore(['ap_codigo' => 17, 'ap_nombre' => 'Reporte Abastecimiento' ,'ap_ruta' => '/admin/reporte-abastecimiento', 'ap_imagen' => null]);
        DB::table('aplicaciones')->insertOrIgnore(['ap_codigo' => 17, 'ap_nombre' => 'Reporte Mantenimientos' ,'ap_ruta' => '/admin/reporte-mantenimiento', 'ap_imagen' => null]);
        ...
        DB::table('aplicacion_perfil')->insertOrIgnore(['pf_codigo' => 1, 'ap_codigo' => 18]);
        /*Policia-Custodio*/
        ...
        /*Jefe Logistica*/
        DB::table('aplicacion_perfil')->insertOrIgnore(['pf_codigo' => 3, 'ap_codigo' => 8]);
        ...
        DB::table('aplicacion_perfil')->insertOrIgnore(['pf_codigo' => 3, 'ap_codigo' => 18]);
        /*Jefe Taller*/
        DB::table('aplicacion_perfil')->insertOrIgnore(['pf_codigo' => 3, 'ap_codigo' => 8]);
        DB::table('aplicacion_perfil')->insertOrIgnore(['pf_codigo' => 4, 'ap_codigo' => 10]);
