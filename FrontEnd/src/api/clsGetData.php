                                            ...
                                            if (filter_var((string)$attrib_td['_isnull'], FILTER_VALIDATE_BOOLEAN)) {
                                                ...
                                                if ((int)$associative == 1) {
                                                    ...
                                                    if ($attrib_td['_type'] == 'string') {
                                                        ...
                                                        $_fecha = DateTime::createFromFormat('Y-m-d\TG:i:s.u', substr(((is_array($data_tr)) ? $data_tr[$i] : $data_tr), 0, 26));
                                                    ...
                                                    } else if ($attrib_td['_type'] == 'int') {
                                                        $dsData[(int)$attrib_tb['_id']][(int)$attrib_tr['_id']][$attrib_td['_name']] = (int)((is_array($data_tr)) ? $data_tr[$i] : $data_tr);
                                                    } else {
                                                    ...
                                                    if ($attrib_td['_type'] == 'string') {
                                                        ...
                                                        $dsData[(int)$attrib_tb['_id']][(int)$attrib_tr['_id']][$attrib_td['_id']] = (int)((is_array($data_tr)) ? $data_tr[$i] : (int)$data_tr);
                                                    } else {
