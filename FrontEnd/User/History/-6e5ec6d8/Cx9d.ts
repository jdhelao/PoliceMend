        ...
        .subscribe(
          {
            next: (data: Catalogo | any) => {
              if (data !== null && data !== undefined && data.ca_codigo !== null && data.ca_codigo !== undefined) {
                ...
                console.log('zzzzzzz'); console.log(this.form.value);
                this.loading = false;
              }
            },
            error: (error) => {
  ...
  onSubmit() {
    ...
    if (navigator.onLine) {
      ...
      (this.form.value.ca_codigo ?
        this.http.put<any>(environment.urlAPI + 'catalogos', this.form.value) :
        this.http.post<any>(environment.urlAPI + 'catalogos', this.form.value))
        .pipe(first())
        .subscribe(
          {
            next: (data: Catalogo | any) => {
