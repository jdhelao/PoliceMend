...
import { RespuestoListComponent } from './respuesto/respuesto-list.component';
import { RespuestoEditComponent } from './respuesto/respuesto-edit.component';
...
const routes: Routes = [
  ...
  { path: 'respuesto', component: RespuestoListComponent },
  { path: 'respuesto/edit/:id', component: RepuestoEditComponent },
  { path: 'respuesto/add', component: RepuestoEditComponent },
